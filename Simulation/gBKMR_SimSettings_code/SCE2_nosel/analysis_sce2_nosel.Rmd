...
```{r}
setwd("/Users/zilanchai/Docs/FinalSimSettings/SCE2_nosel")
sim_popn <- readRDS("popn_lowcor_nonlinearLY_strongL_1.rds")  
```

This script summarizes the Estimate, Bias, Relative Bias,  MSE, Coverage, of `gbkmr with no variable selection` for Scenario 2.  

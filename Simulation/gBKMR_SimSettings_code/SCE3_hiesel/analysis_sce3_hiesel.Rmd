---
title: "SCE3 bkmr hierarchical selection summarization"
author: "Zilan Chai"
date: '2022-10-11'
...
```{r}
setwd("/Users/zilanchai/Docs/FinalSimSettings/SCE3_hiesel") 
```

This script summarizes the Estimate, Bias, Relative Bias,  MSE, Coverage, of `bkmr with grouped hierarchical selection` for Scenario 3.  

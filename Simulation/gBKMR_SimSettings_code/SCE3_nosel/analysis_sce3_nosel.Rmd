---
title: "SCE3 gbkmr noselection summarization"
author: "Zilan Chai"
date: '2022-10-11'
...
```{r}
setwd("/Users/zilanchai/Docs/FinalSimSettings/SCE3_nosel") 
```

This script summarizes the Estimate, Bias, Relative Bias,  MSE, Coverage, of `gbkmr with no variable selection` for Scenario 3.  

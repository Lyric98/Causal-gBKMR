...
#  fitkm_l1 <- kmbayes(y = L1, Z = Exp_mat_l1, X = Cov_mat_l1, iter = 24000, verbose = FALSE, varsel = FALSE)
# saveRDS(fitkm_l1, file = paste0("fitkm_l1_", currind, ".rds"))


fitkm_l1 = readRDS(file = paste0("fitkm_l1_", currind, ".rds"))


# fitkm_l2 <- kmbayes(y = L2, Z = Exp_mat_l2, X = Cov_mat_l2, iter = 24000, verbose = FALSE, varsel = FALSE)
# saveRDS(fitkm_l2, file = paste0("fitkm_l2_", currind, ".rds"))

fitkm_l2 = readRDS(file = paste0("fitkm_l2_", currind, ".rds"))

  fitkm_y <- kmbayes(y = Y, Z = Exp_mat_y, X = Cov_mat_y, iter = 24000, verbose = FALSE, varsel = FALSE)
